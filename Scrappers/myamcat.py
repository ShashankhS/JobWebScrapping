...
def scrape():
    ...
    json_filename = '../ScrappingResults/myamcat.json'
    fp = open(json_filename, 'w')

    joblist = []
    for i in range(117, 120):
        url = 'https://www.myamcat.com/jobs-search-ajax?strEventID=1&strCompanyID=&strMinSalary=0&strMaxSalary=9900000&strStartLimit=0&strKeyword=&strAdvCategoryName=0&strAdvLocationID=0&strAdvSectorID=&strAdvFlagID=0&sortBy=2&strJobRolesList=&strCompaniesList=&strInvitedJobs=0&strFreeSearchText=0&strHeaderJobSearchLocation=&_=1524471212{}%20HTTP/1.1'.format(i)
